...
revived to the *Draft* state and all work orders are restored to their pending (waiting)
state so the standard Odoo manufacturing workflow can resume seamlessly.
