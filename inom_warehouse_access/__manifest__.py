# -*- coding: utf-8 -*-
{
    ...
    'summary': 'Restrict users to authorized warehouse locations and control inventory operations with automatic child-location inheritance and Super Warehouse Manager access.',
    'description': """
