...
class InomSalesReportMonthlyGrowth(models.Model):
    ...
    growth_pct = fields.Float(string="Growth %", readonly=True, aggregator="avg")
...
class InomSalesReportCategory(models.Model):
    ...
    categ_id = fields.Many2one("product.category", string="Product Category", readonly=True)
    revenue = fields.Float(string="Revenue", readonly=True)
    revenue_pct = fields.Float(string="% of Total Revenue", readonly=True, aggregator="avg")
...
class InomSalesReportClv(models.Model):
    ...
    avg_order_value = fields.Float(string="Average Order Value", readonly=True, aggregator="avg")
