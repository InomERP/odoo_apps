...
class InomDashboard(models.TransientModel):
    ...
    def get_dashboard_data(self):
        ...
        """
        # Aggregates run with elevated rights: the dashboard only exposes
        # COUNTS/TOTALS (never record data), so this keeps it working under
        # role-based access without leaking individual records.
