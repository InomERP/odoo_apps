...
def _register_group_privilege(env):
    ...
    Odoo 17 and 18 use ``res.groups.category_id``; Odoo 19 replaced it
    with ``privilege_id``. Both are probed, and if neither exists nothing
    happens - the groups stay assignable from Settings > Users &
    Companies > Groups either way.
    """
