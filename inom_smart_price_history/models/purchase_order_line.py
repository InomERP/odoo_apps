...
class PurchaseOrderLine(models.Model):
    ...
    def create(self, vals_list):
        """F-08: When purchase order lines are created (e.g. on a new RFQ or
        Purchase Order), keep the product's Cost (standard_price) in sync with
        the purchase price entered on the line, mirroring the write() override
        used for later edits.
        """
