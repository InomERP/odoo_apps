...
This copy states the contract for Odoo 18.0, checked against the real 18.0
...
CONTRACT = {
    "res.groups": {
        ...
        "note": "Odoo 18.0: category_id -> ir.module.category directly. "
    ...
    "ir.cron": {
        ...
        "note": "name/model_id/state/code are delegated via "
                ...
                " Odoo 18 dropped numbercall/doall.",
    },
    "mail.mail": {
    ...
    "bus.presence": {
        ...
        "note": "Odoo 18.0: table bus_presence. Renamed to mail.presence "
...
RAW = "https://raw.githubusercontent.com/odoo/odoo/18.0/"
SOURCES = {
...
def main(fetch=False):
    if not fetch:
        for model, spec in CONTRACT.items():
            ...
            print(f"    {spec['note']}")
        print("\nRun with --fetch to check against the 18.0 sources.")
        return 0
